                            ...
                            <div className="flex flex-col gap-2 p-6">
                                <div className="flex flex-row gap-4 items center w-full">
                                    {secondaryAction && secondaryActionLabel && (
                                        <Button label={secondaryActionLabel} disabled={disable} onClick={handleSecondaryAction} outline />
                                    )}
                                    <Button label={actionLabel} disabled={disable} onClick={handleSubmit}  />
                                </div>
                                {footer}
                            </div>
                        </div>
